...
from aiida_cp2k.utils import parse_cp2k_output, parse_cp2k_output_advanced, parse_cp2k_trajectory
...
class Cp2kParser(Parser):
    ...
    def _parse_stdout(self, out_folder):
        ...
        parser_type = 'advanced' #TODO: make this a "metadata" option of the calculation
